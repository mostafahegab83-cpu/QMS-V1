...
For GitHub Pages, upload the contents of this ZIP directly to the repository root. You should see `index.html`, `dashboard.html`, `signup.html`, `css/`, `js/`, and `pages/` at the top level of the repo. Do not leave the app inside a `public/` folder for GitHub Pages.
