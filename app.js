...
(function () {
  ...
  onAuthStateChanged(auth, async (user) => {
    if (user) {
      ...
      // Show signed-in user on the Home page
      const homeEmailEl = document.getElementById("homeUserEmail");
      const homeRoleEl = document.getElementById("homeUserRole");
      if (homeEmailEl) homeEmailEl.textContent = email;
      if (homeRoleEl) homeRoleEl.textContent = admin ? "Admin" : (role || "User");
